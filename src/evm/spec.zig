...
pub const Amsterdam = override(Osaka, .{
    ...
    .account_write = 9000,
    .storage_write = 10000,
    .sstore_clears_schedule = 11616,
    .access_list_address_gas = 2900,
    .access_list_storage_key_gas = 2000,
    .call_value_gas = 11300,
    .gas_table = .{
        .SLOTNUM = 2,
        .DUPN = 3,
        .SWAPN = 3,
        .EXCHANGE = 3,
        .CREATE = 12000, // CREATE_ACCESS
        .CREATE2 = 12000, // CREATE_ACCESS
