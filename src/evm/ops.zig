...
pub fn Ops(comptime cfg: Config) type {
    ...
    return struct {
        ...
        pub fn dupn(next_ip: InstructionPointer, gas: i32, stack_head: u16, frame: *evm.Frame) evm.Errors!void {
        ...
        pub fn swapn(next_ip: InstructionPointer, gas: i32, stack_head: u16, frame: *evm.Frame) evm.Errors!void {
            const n = decodeSingle(frame.code.readByte(next_ip));
            if (stack_head <= n) return evm.Errors.StackUnderflow;
        ...
        pub fn exchange(next_ip: InstructionPointer, gas: i32, stack_head: u16, frame: *evm.Frame) evm.Errors!void {
        ...
        pub fn extcodecopy(next_ip: InstructionPointer, gas: i32, stack_head: u16, frame: *evm.Frame) evm.Errors!void {
            ...
            return next(next_ip, available_gas - fork.constantGas(.EXTCODECOPY) - dynamic_gas, new_stack_head, frame);
        }
        ...
        fn gas_sstore(value: u256, current_value: u256, original_value: u256, is_warm: bool) i32 {
            ...
            const base_dynamic_gas: i32 = if (is_warm) 0 else fork.cold_sload_gas;
        ...
        pub fn create_variant(comptime variant: Opcode) Fn {
            return struct {
                pub fn create(next_ip: InstructionPointer, gas: i32, stack_head: u16, frame: *evm.Frame) evm.Errors!void {
                    ...
                    if (variant == .CREATE2) {
                        const hash_cost: i32 = @intCast(mem.toWordSize(size) * fork.keccak_word_gas);
        ...
        pub fn log_variant(comptime variant: Opcode) Fn {
            return struct {
                pub fn log(next_ip: InstructionPointer, gas: i32, stack_head: u16, frame: *evm.Frame) evm.Errors!void {
                    ...
                    const dynamic_gas = fork.log_size_gas_factor * @as(i32, @intCast(mem_size));
